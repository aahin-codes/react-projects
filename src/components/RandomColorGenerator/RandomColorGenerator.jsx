import "./_randomColorGenerator.scss";
...
export default function RandomColorGenerator() {
  ...
  return (
    <Rendering data={data} renderingComponent={renderingContent} activeType={colorType} buttons={renderingButtons} className={"random-color-generator"} bgColor={color} />
  )
}
